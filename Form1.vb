Public Class Form1
    ...
    Private Sub ButtonClicMethode(sender As Object, e As EventArgs) Handles Num0.Click, Num1.Click, Num2.Click, Num3.Click, Num4.Click, Num5.Click, Num6.Click, Num7.Click, Num8.Click, Num9.Click, OpPoint.Click, OpEqual.Click, OpPlus.Click, OpMinus.Click, OpMulti.Click, OpDevide.Click, OpClear.Click
        ...
        If button.Name = "OpMinus" Then
            TextBox1.Text = TextBox1.Text + "-"
        End If
        If button.Name = "OpMulti" Then
            TextBox1.Text = TextBox1.Text + "*"
        End If
        If button.Name = "OpDevide" Then
            TextBox1.Text = TextBox1.Text + "/"
        End If
